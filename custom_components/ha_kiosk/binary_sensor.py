...
BINARY_SENSORS = (
    ...
    D(key="camera_rtsp_running", name="RTSP сервер камеры", icon="mdi:cctv"),
    D(key="camera_rtsp_audio", name="Звук RTSP", icon="mdi:microphone"),
    D(key="presence_monitor_running", name="Монитор присутствия", icon="mdi:motion-sensor"),
    D(key="presence_paused_for_webrtc", name="Монитор приостановлен для видеопотока", icon="mdi:pause-circle"),
